...
import java.net.URL;
import panel.DialogLoading;
import panel.QuenMatKhau;
import panel.ScannerQR;
import view.main;
import view.mainAD;
...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setFont(new java.awt.Font("Segoe UI", 1, 56)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(66, 88, 190));
        jLabel10.setText("POLOSHOP");
        ...
        txtusername.setBackground(new java.awt.Color(66, 88, 190));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/login/icon/icons8_user_20px_1.png"))); // NOI18N
        ...
        txtpassword.setBackground(new java.awt.Color(66, 88, 190));
        ...
        disable.setIcon(new javax.swing.ImageIcon(getClass().getResource("/login/icon/icons8_invisible_20px_1.png"))); // NOI18N
        ...
        show.setIcon(new javax.swing.ImageIcon(getClass().getResource("/login/icon/icons8_eye_20px_1.png"))); // NOI18N
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 360, 60, 40));
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                ...
                if (nv != null && nv.getMaNV() != null) {
                    System.out.println(nv.getTenNguoiDung());
                    String role = PLS.getUserRole(nv.getTenNguoiDung(), nv.getMatKhau());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (ValidateLG()) {
            ...
            Boolean chk = PLS.checkLogin(username, password);
            NhanVien nv = PLS.getNVLogin(username, password);
            String role = PLS.getUserRole(username, password);
            if (chk) {
                if (role.equalsIgnoreCase("Employee")) {
                    main v = new main();
                    v.setSessionUser(nv);
